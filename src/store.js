...
export default new Vuex.Store({
  ...
  getters: {
    getDuongDa: state => state.DuongDa,
    getLamSach: state => state.LamSach,
    getTrangDiemNen: state => state.TrangDiemNen,
    getChamSocCoThe: state => state.ChamSocCoThe,
    getPhuKien: state => state.PhuKien,
    getAllProducts: state => [...state.DuongDa, ...state.LamSach, ...state.TrangDiemNen, ...state.ChamSocCoThe, ...state.PhuKien],
